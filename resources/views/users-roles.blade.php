    ...
    <body>
            ...
            <div class="content">
                ...
                <!-- end modal for filter Search-->
                        ...
                        <div class="pt-1 w-100 mb-3 d-flex justify-content-between align-items-start">
                            <div>
                            <h5 class="mb-2 me-2 lh-sm"><span class="fa-solid fa-user-pen fs-0"></span> User Roles</h5>
                            </div>
                        </div>
                        </div>

                        <table id="userRolesTable" class="useDataTable responsive table fs--1 mb-0 bg-white my-3 rounded-2 shadow" style="width:100%">
                            <thead >
                                <tr class="px-2 text-head">
                                <th class="dtr-control"></th>
                                <th ></th>
                                    <th class="text-start  text-nowrap"  class="prevent-sort"><span  class="prevent-sort">#</span></th>
                                    <th class="text-start text-start  text-nowrap"><span class="prevent-sort"><i  class="fa-solid fa-circle-info fs-0 px-1  prevent-sort border-0 outline-none" data-bs-placement="top" tabindex="0"  data-bs-toggle="popover" data-bs-trigger="focus" title="" data-bs-content="Role No. info"></i> </span><span  class="prevent-sort">Role No.</span></th>
                                    <th class="text-start text-start  text-nowrap"><span class="prevent-sort"><i  class="fa-solid fa-circle-info fs-0 px-1  prevent-sort border-0 outline-none" data-bs-placement="top" tabindex="0"  data-bs-toggle="popover" data-bs-trigger="focus" title="" data-bs-content="Role Name info"></i> </span><span  class="prevent-sort">Role Name</span></th>
                                    <th class="text-start text-start  text-nowrap"><span class="prevent-sort"><i  class="fa-solid fa-circle-info fs-0 px-1  prevent-sort border-0 outline-none" data-bs-placement="top" tabindex="0"  data-bs-toggle="popover" data-bs-trigger="focus" title="" data-bs-content="No. User info"></i> </span><span  class="prevent-sort">No. User</span> </th>
                                    <th class="text-start text-start  text-nowrap"><span class="prevent-sort"><i  class="fa-solid fa-circle-info fs-0 px-1  prevent-sort border-0 outline-none" data-bs-placement="top" tabindex="0"  data-bs-toggle="popover" data-bs-trigger="focus" title="" data-bs-content="Status info"></i> </span><span  class="prevent-sort">Status</span></th>
                                    <th class="text-start text-start  text-nowrap"><span class="prevent-sort"><i  class="fa-solid fa-circle-info fs-0 px-1  prevent-sort border-0 outline-none" data-bs-placement="top" tabindex="0"  data-bs-toggle="popover" data-bs-trigger="focus" title="" data-bs-content="Created At info"></i> </span><span  class="prevent-sort">Created At</span></th>
                                    <th class="align-middle prevent-sort text-nowrap"><span class="prevent-sort "><i  class="fa-solid fa-circle-info fs-0 px-1  prevent-sort border-0 outline-none" data-bs-placement="top" tabindex="0"  data-bs-toggle="popover" data-bs-trigger="focus" title="" data-bs-content="Action Button info"></i> Action Button </span></th>
                                </tr>
                            </thead>
                            ...
                            <tr>
                                ...
                                <td>active</td>
                                <td>Created At</td>
                                <td class="align-middle white-space-nowrap  ps-3 ps-md-5">
                                <div class="font-sans-serif btn-reveal-trigger position-static text-start"><button class="btn btn-sm bg-light dropdown-toggle dropdown-caret-none transition-none btn-reveal fs--2" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-h fs--2"></span></button>
                                    <div class="dropdown-menu dropdown-menu-start py-2"><a class="dropdown-item" href="#!">View</a><a class="dropdown-item" href="#!">Export</a>
                            ...
                            <tr>
                                ...
                                <td>12/1/2202</td>
                                <td class="align-middle white-space-nowrap  ps-3 ps-md-5">
                                <div class="font-sans-serif btn-reveal-trigger position-static text-start"><button class="btn btn-sm dropdown-toggle dropdown-caret-none bg-light transition-none btn-reveal fs--2" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-h fs--2"></span></button>
                                    <div class="dropdown-menu dropdown-menu-start py-2"><a class="dropdown-item" href="#!">View</a><a class="dropdown-item" href="#!">Export</a>
                                    <div class="dropdown-divider"></div><a class="dropdown-item text-danger" href="#!">Remove</a>
                                    </div>
                                </div>
        ...
        <script src="vendors/datatable/popover.js">

        </script>

        <!-- data table -->
        <script src="vendors/datatable/dataTables.js"></script>
        <script src="vendors/datatable/dataTables-bootstrap5.js"></script>
        <script src="vendors/datatable/dataTables.responsive.min.js"></script>
        <script src="vendors/datatable/dataTables.responsive.bootstrap5.js"></script>
        ...
        <script src="vendors/datatable/dataTables-select.js"></script>
        <script src="vendors/datatable/dataTables-select-bootstrap5.js"></script>

        <script  src="vendors/datatable/customdatatable.js"></script>
